...
def calculate(numFiber, comName):
    while True:
        try:
            fiberFeet = int(numFiber)
            if fiberFeet < 100:
                installCost = fiberFeet * .87
            elif fiberFeet > 100 and fiberFeet <= 250:
                installCost = fiberFeet *.8
            elif fiberFeet > 250 and fiberFeet <= 500:
                installCost = fiberFeet *.7
            elif fiberFeet > 500:
                installCost = fiberFeet *.5
            else:
                pass
